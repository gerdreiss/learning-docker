# Dockerized Example React App

Project created in the context of the Udemy Course [Docker and Kubernetes: The Complete Guide](https://www.udemy.com/docker-and-kubernetes-the-complete-guide)

[![Build Status](https://travis-ci.org/gerdreiss/learning-docker.svg?branch=master)](https://travis-ci.org/gerdreiss/learning-docker)

This project was bootstrapped with (and the entire text below was generated by) [Create React App](https://github.com/facebook/create-react-app).
